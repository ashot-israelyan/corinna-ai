...
import { CustomerPaymentForm } from '@/components/forms/portal/payment-form';
...
const PaymentCheckout: FC<Props> = ({ onNext, amount, products, stripeId }) => {
							...
							products.map((product, key) => (
								<Card key={key} className="w-full flex gap-2 p-3">
									<div className="w-2/12 aspect-square relative">
										<Image src={`https://ucarecdn.com/${product.image}/`} alt="product" fill />
									</div>
